...
[![Go Report Card](https://goreportcard.com/badge/github.com/MondaleFelix/makesite)](https://goreportcard.com/report/github.com/MondaleFelix/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [ ] **_FILL IN THE BLANK_**: `I will use the html-to-markdown library. The documentation is located at https://github.com/JohannesKaufmann/html-to-markdown. My goal is to use it to complete this objective.`
- [x] **Add, commit, and push to GitHub**.
